...
var _locationMixin = __webpack_require__(8);

var _locationMixin2 = _interopRequireDefault(_locationMixin);

var _queryParamsMixin = __webpack_require__(10);
...
var _fragments = __webpack_require__(13);
...
var ProgressiveShell = function (_QueryParamsMixin) {
  _inherits(ProgressiveShell, _QueryParamsMixin);

  _createClass(ProgressiveShell, null, [{
    key: 'is',
    get: function get() {
      return 'progressive-shell';
    }
  }, {
    key: 'observedAttributes',
    get: function get() {
      var observedAttributes = _get(ProgressiveShell.__proto__ || Object.getPrototypeOf(ProgressiveShell), 'observedAttributes', this) || [];
      return observedAttributes.concat(['params', 'queryParams', 'currentRoute']);
    }
  }]);

  function ProgressiveShell() {
    _classCallCheck(this, ProgressiveShell);

    var _this = _possibleConstructorReturn(this, (ProgressiveShell.__proto__ || Object.getPrototypeOf(ProgressiveShell)).call(this));

    var shadowRoot = _this.attachShadow({ mode: 'open' });
    shadowRoot.appendChild(document.createElement('slot'));
    _this.routeTemplates = {};
    return _this;
  }

  _createClass(ProgressiveShell, [{
    key: 'connectedCallback',
    value: function connectedCallback() {
      var _this2 = this;

      if (_get(ProgressiveShell.prototype.__proto__ || Object.getPrototypeOf(ProgressiveShell.prototype), 'connectedCallback', this)) {
        _get(ProgressiveShell.prototype.__proto__ || Object.getPrototypeOf(ProgressiveShell.prototype), 'connectedCallback', this).call(this);
      }
    ...
    value: function disconnectedCallback() {
      if (_get(ProgressiveShell.prototype.__proto__ || Object.getPrototypeOf(ProgressiveShell.prototype), 'disconnectedCallback', this)) {
        _get(ProgressiveShell.prototype.__proto__ || Object.getPrototypeOf(ProgressiveShell.prototype), 'disconnectedCallback', this).call(this);
      }
    ...
    value: function _propertiesChanged(currentProps, changedProps, oldProps) {
      if (_get(ProgressiveShell.prototype.__proto__ || Object.getPrototypeOf(ProgressiveShell.prototype), '_propertiesChanged', this)) {
        _get(ProgressiveShell.prototype.__proto__ || Object.getPrototypeOf(ProgressiveShell.prototype), '_propertiesChanged', this).call(this, currentProps, changedProps, oldProps);
      }
    ...
    key: '_contentAdded',
    value: function _contentAdded(parts) {
      var _this3 = this;
      ...
      parts.forEach(function (node) {
        if (node.tagName.toLowerCase() === 'progressive-header') {
          ...
          if (_this3._page) {
            _this3._previousPage = _this3._page;
          }
          _this3._page = node;
    ...
    value: function _pathChanged(path) {
      ...
      var pathFound = false;
      Object.entries(_fragments2.default.routing).forEach(function (route) {
        if (pathFound) return;
        var params = {};
        var keys = [];
        ...
        if (exec) {
          ...
          for (var k in _fragments2.default.partials) {
            partials.push({
              name: k,
              partial: _fragments2.default.partials[k]()
            });
          }

          var newPath = path.indexOf('?') < 0 ? path + '?data=true' : path + '&data=true';

          var promises = [_fragments2.default.routing[route[0]].page(), _fragments2.default.routing[route[0]].header(), _fragments2.default.routing[route[0]].footer(), fetch(newPath).then(function (response) {
            return response.json();
          }), _fragments2.default.httpCodes.unauthorized.page()].concat(partials.map(function (i) {
            return i.partial;
          }));

          if (_this4.currentRoute) {
            promises = promises.concat([_fragments2.default.routing[_this4.currentRoute].page(), _fragments2.default.routing[_this4.currentRoute].header(), _fragments2.default.routing[_this4.currentRoute].footer()]);
          }
          ...
          Promise.all(promises).then(function (result) {
            ...
            if (_this4.currentRoute && _this4.currentRoute !== route[0]) {
            ...
            json.data.queryParams = _this4.paramsObject;

            if (_this4.path === path) {
              if (json.status === 401) {
                page = unauthorized;
              }
              _this4._renderPage(page.template, json.data);
              ...
              for (var i in partials) {
                if (partials[i].name === 'header') {
                  ...
                  _this4._renderPartial(partials[i].name, header.template, json.data);
                } else if (partials[i].name === 'footer') {
                  if (footer === 'default') {
                    footer = partialResults[i];
                  }
                  _this4._renderPartial(partials[i].name, footer.template, json.data);
                }
              }
      ...
      if (!pathFound) {
        _fragments2.default.httpCodes.notfound.page().then(function (res) {
          _this4._renderPage(res.template, {});
        });
      }
    }
  }, {
    key: '_renderPage',
    value: function _renderPage(template, data) {
      var html = template(data);
      this._page.innerHTML = html;
    }
  }, {
    key: '_renderPartial',
    value: function _renderPartial(partial, template, data) {
      var html = template(data);
      if (this['_' + partial]) {
...
exports.default = { routing: { '/': { page: function page() {
        ...
        return __webpack_require__.e/* import() */(5).then(__webpack_require__.bind(null, 15));
      }, header: function header() {
        return Promise.resolve('default');
      }, footer: function footer() {
        return Promise.resolve('default');
      } }, '/test': { page: function page() {
        return __webpack_require__.e/* import() */(3).then(__webpack_require__.bind(null, 16));
      }, header: function header() {
        return Promise.resolve('default');
      }, footer: function footer() {
        return Promise.resolve('default');
      } }, '/authorized': { page: function page() {
        return __webpack_require__.e/* import() */(7).then(__webpack_require__.bind(null, 17));
      }, header: function header() {
        return Promise.resolve('default');
      }, footer: function footer() {
        return Promise.resolve('default');
      } } }, httpCodes: { 'unauthorized': { page: function page() {
        return __webpack_require__.e/* import() */(2).then(__webpack_require__.bind(null, 18));
      }, header: function header() {
        return Promise.resolve('default');
      }, footer: function footer() {
        return Promise.resolve('default');
      } }, 'notfound': { page: function page() {
        return __webpack_require__.e/* import() */(4).then(__webpack_require__.bind(null, 19));
      }, header: function header() {
        return Promise.resolve('default');
      }, footer: function footer() {
        return Promise.resolve('default');
      } } }, partials: { 'header': function header() {
